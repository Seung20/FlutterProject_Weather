...
class Model{
  Widget? getWeatherIcon(int condition){
    if(condition < 300){
      return SvgPicture.asset('svg/climacon-cloud_lightning.svg', width: 250, height: 250,
      // color: Colors.black87,
          );
    }
    else if(condition < 600){
      return SvgPicture.asset('svg/climacon-cloud_snow_alt.svg', width: 250, height: 250,
          // color: Colors.black87,
          );
    }
    else if(condition == 800){
      return SvgPicture.asset('svg/climacon-sun.svg', width: 250, height: 250,
       // color: Colors.black87,
      );
    }
    else if(condition <= 804){
      return SvgPicture.asset('svg/climacon-cloud_sun.svg', width: 250, height: 250,
        //color: Colors.black87,
          );
    }
  ...
  Widget? getAirCondition(int index){
    if(index == 1)
      return Text('매우 좋음', style: TextStyle(color: Colors.indigo, fontWeight: FontWeight.bold),);
    else if(index == 2)
      ...
      return Text('존나 나쁨', style: TextStyle(color: Colors.indigo, fontWeight: FontWeight.bold),);
  }
}